...
export const Register = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white via-blue-50 to-white px-6 py-20">
      <motion.div 
      ...
      >
        ...
        >
          ...
          >
            Create <span className="bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">Account</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          {[
            ...
            { name: "phone", type: "tel", label: "Phone Number", placeholder: "+91 9876543210" },
